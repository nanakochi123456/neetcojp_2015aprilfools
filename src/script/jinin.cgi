...
var _gaq = _gaq || [];_gaq.push(['_setAccount', 'UA-46303321-1']);_gaq.push(['_trackPageview']);(function() {var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true;ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js';var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);})();</script></head><body><a href="index.html@{[$::form{hash} ne "" ? "?hash=$::form{hash}" : ""]}"><img src="ENCNAME.JPG@{[$::form{hash} ne "" ? "?hash=$::form{hash}" : ""]}"></a><audio autoplay><source src="audio/hotaru.mp3"><source src="audio/hotaru.ogg"></audio></body><!--ｲﾁｵｰｷｮｳﾊ2015ｴｲﾌﾟﾘｰﾙﾌｰﾙﾅﾝﾃﾞｽｶﾞ--></html>
EOM
